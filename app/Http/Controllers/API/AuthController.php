...
class AuthController extends Controller
{
    public function SignUp(Request $request){
        ...
        $code = (rand(1, 1000000));
        $request['code'] = $code;
        $requestData['contact_person_name'] = $request->input('contact_person_name');
        $requestData['contact_person_phone'] = $request->input('contact_person_phone');
        if ($request->hasFile('company_paper_attachment')) {
