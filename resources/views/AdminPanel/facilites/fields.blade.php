...
<div class="card-body border-top p-9">
    ...
    <div class="tab-content mt-5" id="myTabContent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[description]" class="summernote"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                placeholder="{{ __('lang.description') }}">{{ isset($facilite)? $facilite->getTranslation($name)->description : '' }} </textarea>
                            <div
        ...
        <div class="fv-row mb-10 fv-plugins-icon-container">
            ...
            <div class="image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
                ...
                <div class="image-input-wrapper w-125px h-125px" @isset($facilite->main_photo)
                    style='background-image:url({{$facilite->main_photo}})'@endisset>
                </div>
                    ...
                    @if(isset($facilite) && count($facilite->photos) > 0 )
                        @foreach ($facilite->photos as  $photo)
                            <div class="dz-preview dz-processing dz-image-preview dz-success dz-complete">
                                <div class="dz-image"><img data-dz-thumbnail="" alt="{{$facilite->title}}" src="{{$photo->photo}}" >
                                </div>
    ...
    <script>
        ...
        var myDropzone = new Dropzone("#kt_modal_create_project_settings_logo", {
            url: '{{url("image/upload/facilites")}}',
            paramName: "photo",
            //maxFilesize: 2,
    ...
    <script>
        $('.delete').each(function(e){
            $(this).on('click',function(){
                let button = this;
                $.ajax({
                url :"{{ url(LaravelLocalization::getCurrentLocale().'/facilities/image/delete/') }}/" + this.getAttribute('data-image-id'),
                type: 'GET',
                headers: {
                '__token':'{{csrf_token()}}',
                },
