                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type='text' name="{{$name}}[title]"
                                ...
                                placeholder="{{ __('lang.title') }}" value="{{isset($page)? $page->getTranslation($name)->title : '' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[description]" class="summernote"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                placeholder="{{ __('lang.description') }}">{{ isset($page)? $page->getTranslation($name)->description : '' }} </textarea>
                            <div
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type='text' name="{{$name}}[seo]" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                placeholder="{{ __('lang.seo') }}" value="{{ isset($page)? $page->getTranslation($name)->seo : '' }}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <!--end::Col-->
