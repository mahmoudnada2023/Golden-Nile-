...
<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
    ...
    <thead>
        <tr class="fw-6 fw-semibold text-gray-600">
            ...
            <th class="min-w-250px">{{ __('lang.contact_person_name') }}</th>
            <th class="min-w-250px">{{ __('lang.contact_person_phone') }}</th>
            <th class="min-w-250px">{{ __('lang.company_paper_attachment') }}</th>
    ...
    <tbody>
        @foreach ($users as $user)
            <tr>
                ...
                <td>
                    <span class=" fs-7 fw-bold">{{ $user->contact_person_name}}</span>
                </td>
                <td>
